...
public class ErrorCode {
    ...
    public static final String CUSTOMER_SECURITY_IMAGE_NOT_FOUND_ERROR_CODE="CSI-CREATE-FIE-003";
    public static final String CUSTOMER_SECURITY_IMAGE_INVALID__ERROR_CODE="CSI-CREATE-FIE-002";
}
